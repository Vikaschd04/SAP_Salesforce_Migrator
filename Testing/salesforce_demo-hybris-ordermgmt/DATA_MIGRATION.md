...
|---|---|---|---|
| `Customer__c` | 5 | `Uid__c` | INSERT_UPDATE |
| `Order__c` | 5 | `Code__c` | INSERT_UPDATE |
| `OrderEntry__c` | 7 | `EntryNumber__c` | INSERT_UPDATE |
| `Product__c` | 6 | `Code__c` | INSERT_UPDATE |
...
sf data upsert bulk --sobject OrderEntry__c --file data/OrderEntry__c.csv --external-id EntryNumber__c --wait 10
